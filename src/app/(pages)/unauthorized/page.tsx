      ...
      <AnimatedContainer animation="slideUp" delay={0}>
        <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-sm p-8 text-center">
          <div className="flex flex-col items-center">
            <AnimatedContainer animation="bounce" delay={0.1} className="relative mb-6">
            ...
            <AnimatedContainer animation="fade" delay={0.2}>
              <h1 className="text-3xl font-bold text-cyan-700 mb-2">Acceso Restringido</h1>
            </AnimatedContainer>
            ...
            <AnimatedContainer animation="slideUp" delay={0.4} className="space-y-3 w-full">
              <Button
