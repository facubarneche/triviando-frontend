    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className={cn(getGlassClasses(), 'max-w-sm p-0 sm:max-w-lg')}>
        <DialogHeader className="items-center gap-2 px-5 pt-6 text-center sm:gap-3 sm:px-6 sm:pt-8">
          <div className="flex h-12 w-12 items-center justify-center rounded-full border border-amber-100 bg-white shadow-sm sm:h-16 sm:w-16">
            <AlertCircle className="h-6 w-6 text-amber-500 sm:h-8 sm:w-8" />
          </div>
