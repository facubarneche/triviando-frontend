  ...
  'rounded-xl border shadow-lg transition-all duration-300 cursor-default text-gray-700',
  {
    variants: {
      variant: {
        ...
        default: 'bg-white/95 backdrop-blur-md border-white/30',
        ...
        // Card destacado
        highlighted:
          'bg-gradient-to-br from-teal-50/95 to-cyan-50/95 backdrop-blur-md border-teal-200/50 hover:border-teal-300/60',
        ...
        // Card de warning
        warning:
          'bg-gradient-to-br from-amber-50/95 to-orange-50/95 backdrop-blur-md border-amber-200/50',
      },
      size: {
        sm: 'p-3',
        default: 'p-4',
